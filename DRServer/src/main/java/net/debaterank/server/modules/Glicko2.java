...
public class Glicko2 implements Runnable {
    ...
    private void updateRankings() {
        ...
        List<Double> seasonsResult = session.createNativeQuery("SELECT DISTINCT EXTRACT(year FROM date) FROM tournament " +
        ...
        for(String season : seasons) {
            ...
            List<Object[]> debates = session.createNativeQuery("SELECT event.id,tournament_id, a_id, n_id, " +
